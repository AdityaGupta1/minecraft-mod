...
public class WorldGeneratorEnergetic implements IWorldGenerator {
	@Override
	...
	private void generateSurface(World world, Random random, int BlockX,
		...
		for (int i = 0; i < 10; i++) {
			...
			int Ycoord = random.nextInt(6);
			(new WorldGenMinable(IndustrialMod.energeticore.blockID, 4)).generate(
